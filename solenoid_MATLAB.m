...
while true                                                  % Create while statement for true
    ...
    if strcmp(user_input,'D')                               % If statement with strcmp() logicial statement
        ...
        pause(0.01);
    elseif strcmp(user_input,'C')                           % Elseif statement with strcmp() logicial statement
        send_str = 'C';                                     % Creates send_str variable as a string 'C'
        fprintf(a, '%s', send_str);                         % fprintf() to send signal to Arduino software and display string text
        pause(0.01);
    elseif strcmp(user_input,'q')                           % Elseif statement with strcmp() logicial statement
